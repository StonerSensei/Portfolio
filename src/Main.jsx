  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <h2 className='names'>Parth</h2>
        <p className='i_am_a'>I am a&nbsp;<span class="typewriter"></span></p>
        
        <div className="flex1">
        <p className='follow_me'>follow me: </p>
        <div className="logos">
        <a href="https://www.codechef.com/users/stoner20"><img src={codechef} alt="" /></a>
        <a href="https://github.com/StonerSensei" target="_blank" rel="noreferrer"><img src={github} alt=""  /></a>
        <a href="https://www.linkedin.com/in/parth-tiwari-661837259?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noreferrer"><img src={linked_in} alt=""></img></a>
        <a href="https://leetcode.com/u/Parth_2003/" target="_blank" rel="noreferrer"><img src={leetcodes} alt=""></img></a>
        </div>
        </div>
        <div className="flex1">
        <button onClick={() => window.open("https://drive.google.com/file/d/1DfwX9n3phleIj1ZI-IX43GWB30DBytS3/view?usp=sharing", "_blank")} className='buttonb'>Resume</button>
        </div>
      </div>
